...
package group.chat.application;

/**
 *
 * @author Ramji Chauhan
 */
...
public class user3 implements ActionListener, Runnable {
    ...
    user3() {
        ...
        ImageIcon i13 = new ImageIcon(ClassLoader.getSystemResource("icons/dot3.png"));
        ...
        JLabel status = new JLabel("Tanishq , Vansh , Dheeraj ");
